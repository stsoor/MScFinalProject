...
class HypergraphConvolutionalNetwork:
    ...
    def train(self, problem, evaluator, population_size, selection_pct, mutation_pct, mutation_random_generator, max_iteration_num, target_score=None, crossover_pct=0.5, debug=None):
        ...
        optimizer = NaiveGA(lower_bounds, upper_bounds, initializer, hgcn_evaluator, population_size, selection_pct, mutation_pct, mutation_random_generator, max_iteration_num, target_score, crossover_pct, debug)
